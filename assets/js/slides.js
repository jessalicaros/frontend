...
async function getDatas() {
  ...
  const response = await fetch(backendURL + "/api/real-estate-properties", {
    headers: {
  ...
  if (response.ok) {
    ...
    json.data.forEach((element) => {
      ...
      <div class="card w-100 mt-3" data-id="${element.property_id}">
          <div class="col-sm-8">
              <div class="card-body">
                  ...
                  <p class="card-text"><strong>Property Type:</strong> ${element.property_type}</p>
                  <p class="card-text"><strong>Address:</strong> ${element.address}</p>
                  <p class="card-text"><strong>Bedrooms:</strong> ${element.bedrooms}</p>
                  <p class="card-text"><strong>Real Estate ID:</strong> ${element.real_estate_id}</p>
                  <p class="card-text"><strong>Status:</strong> ${element.status}</p>
                  <p class="card-text"><strong>Bathrooms:</strong> ${element.bathrooms}</p>
                  <p class="card-text"><strong>Square Footage:</strong> ${element.squarefootage}</p>
                  <p class="card-text"><strong>Listing Price:</strong> ${element.listing_price}</p>
